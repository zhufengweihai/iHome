...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int textIndicatorColor = 0xFF000000;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        showIndicator = a.getBoolean(R.styleable.PagerSlidingTabStrip_showIndicator, showIndicator);
        indicatorColor = a.getColor(R.styleable.PagerSlidingTabStrip_indicatorColor, indicatorColor);
        showUnderline = a.getBoolean(R.styleable.PagerSlidingTabStrip_showUnderline, showUnderline);
        underlineColor = a.getColor(R.styleable.PagerSlidingTabStrip_underlineColor, underlineColor);
        showDivider = a.getBoolean(R.styleable.PagerSlidingTabStrip_showDivider, showDivider);
        ...
        dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_paddingDivider, dividerPadding);
        ...
        textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_textCaps, textAllCaps);
        textIndicatorColor = a.getColor(R.styleable.PagerSlidingTabStrip_textIndicatorColor, textIndicatorColor);
        a.recycle();

        if (showIndicator || showUnderline) {
            rectPaint = new Paint();
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (currentPosition == i) {
                    tab.setTextColor(textIndicatorColor);
                } else {
                    tab.setTextColor(tabTextColor);
                }
            }
